...
use App\Juicio, App\Demandado, App\Juiciouser, App\Juzgadotipo, App\Juzgado, App\Juiciotipo, App\Moneda, App\Macroetapa, App\Salaapela, App\User, App\Estado, App\Nota, App\JuiciosOficio;
use \stdClass;
...
class JuiciosExport implements FromCollection, WithMapping, WithHeadings
{
    ...
    */
    public function map($juicio): array
    {
      ...
      $oficios        = JuiciosOficio::where("juicio_id", $juicio->id)->get();
